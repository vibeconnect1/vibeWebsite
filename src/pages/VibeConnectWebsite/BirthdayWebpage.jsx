...
function BirthdayWebPage() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <h1 className="text-2xl lg:text-5xl font-bold  text-white mb-4">Birthday</h1>
  ...
  <div className="flex flex-col gap-8 lg:flex-row justify-between items-center mb-12">
        ...
        The birthday feature in Vibe Connect is designed to help teams effortlessly celebrate important milestones. It automatically tracks employee birthdays and sends timely reminders to ensure no special day goes unnoticed. Users can customize birthday messages, schedule celebrations, or plan group activities, creating a culture of appreciation and recognition within the organization. This feature also allows for personalized notifications, ensuring that each employee feels valued on their special day. By making it easy to acknowledge birthdays, it enhances team bonding, improves workplace morale, and contributes to a more positive and inclusive company culture.   </p>
        </div>
        {/* Image */}
...
export default BirthdayWebPage;
