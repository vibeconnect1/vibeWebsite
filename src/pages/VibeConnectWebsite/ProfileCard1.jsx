...
const profiles = [
  {
    ...
    text1:
      "Project & Task Planning: Provides tools for planning projects,managing sub-task  dependencies, and tracking progress using Kanban or list views, with milestones. Offers task assignment, tracking, and management of deadlines with reminders for timely completion.",
    text2:
      "Integration with Tools like WhatsApp for assigning and reminder of pending task.",
  ...
  },
  {
    ...
    text1:
      "Collaboration Tools: Facilitates document sharing, team collaboration spaces, and internal chats. With intuitive interfaces, teams can collaborate in real time, driving innovation and enhancing productivity.",
    text2:
      "Calendar Integration: Supports multiple calendar integration with auto-sync functionality.This feature allows users to schedule meetings and events effortlessly while ensuring that everyone stays up-to-date with their commitments. ",
  ...
  },
  {
    ...
    text1:
      "	Digital Business Card: : Enables digital contact sharing and customizable business cards. This feature not only promotes professional networking but also reduces paper waste, aligning with sustainable business practices. ",
    text2:
      "	Field Sense: Facilitates field data collection with mobile access for sales, business development, and operations teams. This tool enhances real-time data accuracy and enables teams to make informed decisions on the go. ",
...
const ProfileCard1 = () => {
  ...
  return (
    <div className="min-h-screen relative bottom-0">
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-6 lg:gap-10 py-14 lg:py-10 mx-2">
        {/* Sidebar with Profile Images */}
        <div className="flex flex-col items-start space-y-2 md:space-y-6 py-4 lg:py-8 lg:ml-20  p-4 xl:ml-52">
        ...
        <div
          ref={observerRef}
          className="lg:w-2/5 py-6 md:py-10 px-4 md:px-6 lg:mr-20 xl:mr-14"
        >
          {profiles.map(
            (profile) =>
