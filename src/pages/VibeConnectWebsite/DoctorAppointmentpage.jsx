...
import asset from '../../../Website Image/doctor.jpeg';
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <h1 className="text-2xl lg:text-5xl font-bold  text-white mb-4">Doctor Appointment</h1>
    ...
    <svg className="relative block w-full h-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
      ...
      <div className="flex flex-col gap-8 lg:flex-row justify-between items-center mb-12">
        ...
        {/* <h3 className="text-xl lg:text-3xl font-bold  mb-2">			Doctor Appointment</h3> */}

        <p className="lg:text-xl  mb-4 text-justify font-serif text-gray-800 leading-relaxed tracking-tight">
        Scheduling doctor appointments becomes a breeze with Vibe Connect’s intuitive system, designed to help users manage their healthcare needs efficiently. Whether it’s for routine check-ups, specialist consultations, or urgent medical care, the platform ensures you have complete control over your appointments. Users can easily book, reschedule, or cancel appointments, all while keeping track of their medical history in one place. With reminders and notifications integrated into the system, there’s no risk of missing important appointments. Additionally, the platform offers an organized interface for both patients and healthcare providers, enhancing communication and ensuring that every detail, from appointment timing to medical notes, is accurately documented. This feature not only simplifies appointment management but also brings an added layer of convenience and reliability, allowing you to focus on your health without any distractions. </p>
