...
import asset from '../../../Website Image/leave.jpeg';
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold  text-white mb-4">Leave Management</h1>
    ...
    <svg className="relative block w-full h-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
      ...
      <div className="flex flex-col gap-8 lg:flex-row justify-between items-center mb-12">
        ...
        {/* <h3 className="text-3xl font-bold  mb-2">			Leave Management</h3> */}

        <p className="md:text-lg lg:text-xl  mb-4 text-justify font-serif text-gray-800 leading-relaxed">
        Vibe Connect's leave management feature simplifies the entire process by providing a centralized platform for both employees and managers. It allows employees to submit leave requests, track their leave balances, and receive timely notifications regarding approvals or rejections. Managers benefit from an intuitive dashboard that enables them to oversee leave applications, manage team availability, and ensure adequate staffing levels. This feature also facilitates compliance with company policies and legal requirements by maintaining accurate records and generating insightful reports. By automating the leave management process, Vibe Connect empowers organizations to foster a more organized and transparent approach to employee time off, ultimately contributing to a positive workplace culture.</p>
