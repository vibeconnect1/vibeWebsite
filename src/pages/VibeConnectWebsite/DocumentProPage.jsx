...
import asset from '../../../Website Image/document2.jpeg';

import VibeConnectNavbar1 from "./VibeConnectNavbar1";
import VibeConnectFooter from "./VibeConnectFooter";

function DocumentProPage() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold  text-white mb-4">Document Pro</h1>
    ...
    <svg className="relative block w-full h-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
      ...
      <div className="flex flex-col gap-8 lg:flex-row justify-between items-center mb-12">
        ...
        {/* <h3 className="text-3xl font-bold  mb-2">			Document Pro</h3> */}

        <p className="lg:text-xl  mt-4 text-justify font-serif text-gray-800 leading-relaxed">
        Facilitates document storage, version control, and access management. Simplify document management with Vibe Connect’s Documents Pro. Efficiently organize, access, and secure all your important documents in one centralized location. Vibe connect Implements robust document storage solutions, streamline retrieval processes, and enhance collaboration with seamless sharing features. Maintain control and security over your documents, ensuring they are always at your fingertips when you need them. </p>
...
export default DocumentProPage
