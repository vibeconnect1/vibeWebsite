  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <h1 className="text-2xl lg:text-5xl font-bold  text-white mb-4">Project & Task Management</h1>
